	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN siswa ON pengaduan.nisn=siswa.nisn ORDER BY pengaduan.id_pengaduan DESC");
		...
		<tr>
			...
			<td>
				<a class="btn modal-trigger blue" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Lihat</a>  
