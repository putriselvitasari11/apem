        <div class="row">
          ...
          <div class="col s12 m3">
            ...
            <a class="waves-effect waves-light btn blue" href="cetak.php">print</a>
          </div>
        </div>
	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN siswa ON pengaduan.nisn=siswa.nisn INNER JOIN tanggapan ON tanggapan.id_pengaduan=pengaduan.id_pengaduan INNER JOIN petugas ON tanggapan.id_petugas=petugas.id_petugas ORDER BY tgl_pengaduan DESC");
		...
		<tr>
			...
			<td><a class="btn blue modal-trigger" href="#laporan?id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Lihat</a></td>
